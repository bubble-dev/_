...
export const defaultTheme: TTheme = {
  ...
  navigationSidebarActiveItemColor: Colors.WHITE,
  ...
  controlsSidebarColor: Colors.WHITE,
  controlsSidebarIconBackgroundColor: [0x42, 0x41, 0x40, 1],
  controlsSidebarIconColor: Colors.WHITE,

  toolbarBackgroundColor: [0x21, 0x20, 0x20, 1],
  toolbarIconColor: Colors.WHITE,
  toolbarIconHoveredColor: Colors.WHITE,
  toolbarIconPressedColor: Colors.WHITE,
  ...
  toolbarIconFocusedBorderColor: Colors.WHITE,
  ...
  sourceCodeActiveLineColor: Colors.WHITE,
