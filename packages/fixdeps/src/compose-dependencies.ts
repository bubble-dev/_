...
export const composeDependencies = (dependenciesObject: TDepsObject | undefined, depsToAddWithVersions: TDepsEntries, depsToRemove: string[]): TDepsObject | undefined => {
